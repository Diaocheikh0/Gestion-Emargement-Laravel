...
Route::delete('cours-professeurs/{cours_id}/{prof_id}', [CoursProfesseurController::class, 'destroy'])->name('destroy')->middleware('auth');
...
Route::resource('graphiqueBarres', \App\Http\Controllers\GraphiqueBarreController::class)->middleware('auth');
Route::resource('graphiqueLigne', \App\Http\Controllers\GraphiqueLigneController::class)->middleware('auth');
Route::resource('graphiqueDoughnut', \App\Http\Controllers\GraphiqueDoughnutController::class)->middleware('auth');
